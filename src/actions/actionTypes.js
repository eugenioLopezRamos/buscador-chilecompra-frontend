...
export const USER_POST_RESULTS = "USER_POST_RESULTS";
export const USER_POST_RESULTS_SUCCESS = "USER_POST_RESULTS_SUCCESS";
export const USER_POST_RESULTS_DELETE = "USER_POST_RESULTS_DELETE";

export const USER_PUT_RESULTS = "USER_PUT_RESULTS";
export const USER_PUT_RESULTS_SUCCESS = "USER_PUT_RESULTS_SUCCESS";
export const USER_PUT_RESULTS_FAILURE = "USER_PUT_RESULTS_FAILURE";
...
export const USER_GET_QUERIES = "USER_GET_QUERIES";
export const USER_GET_QUERIES_SUCCESS = "USER_GET_QUERIES_SUCCESS";
export const USER_GET_QUERIES_FAILURE = "USER_GET_QUERIES_FAILURE";

export const USER_POST_QUERIES = "USER_POST_QUERIES";
export const USER_POST_QUERIES_SUCCESS = "USER_POST_QUERIES_SUCCESS";
export const USER_POST_QUERIES_FAILURE = "USER_POST_QUERIES_FAILURE";

export const USER_PUT_QUERIES = "USER_PUT_QUERIES";
export const USER_PUT_QUERIES_SUCCESS = "USER_PUT_QUERIES_SUCCESS";
export const USER_PUT_QUERIES_FAILURE = "USER_PUT_QUERIES_FAILURE";

export const USER_DELETE_QUERIES = "USER_DELETE_QUERIES";
export const USER_DELETE_QUERIES_SUCCESS = "USER_DELETE_QUERIES_SUCCESS";
export const USER_DELETE_QUERIES_FAILURE = "USER_DELETE_QUERIES_FAILURE"
